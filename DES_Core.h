...
void key_merge_subkey(unsigned char *left_key_28,unsigned char *right_key_28,unsigned *subkey); //将两个28key合并位子密钥
void key_subkeys_generate(unsigned char *key_56,unsigned subkeys[][6]); //转置后的56位密钥生成16轮子密钥
